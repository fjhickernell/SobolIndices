...
\end{lemma}
\textit{Proof}:For each $\ell\geq 1$, digital shift and scrambling operations carried out in equations (\ref{linear.scrambl}) and (\ref{dig.shift}) are bijections. Hence, same coordinates of $B_\ell$ and ${B'}_\ell$ will contain the same set of $2^r$ values.
