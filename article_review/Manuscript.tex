...
\comment{\begin{equation}
 \widehat{\sigma}^2 = \frac{1}{2(n-1)} \sum \limits_{i=0}^{n-1} \left[\left( f(\vx_i) - \widehat{\mu}\right)^2 + \left( f(\vx'_i) - \widehat{\mu}\right)^2\right],
 \end{equation}
with
\begin{equation}
\widehat{\mu} =  \frac{1}{2n} \sum \limits_{i=0}^{n-1} \left[ f(\vx_i)+f(\vx'_i)\right].
\label{mu.est}
\end{equation}}
