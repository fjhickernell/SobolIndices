...
Running Ishigami example ... $\varepsilon=10^{-2}$

\[
\begin{array}{lccc}
   & u=\{1\} & u=\{2\} & u=\{3\} \\ \hline \hline
 \widehat{\underline{S}}_u & 0.3144  &  0.4371  &  0 \\ \hline
 n & 4096  &  2048  &  1024 \\ \hline
 \text{error} & 0.0005  &  0.0054   &   0 \\ \hline
 \widehat{\overline{S}}_u & 0.5608  &  0.4428  &   0.2445 \\  \hline
 n & 2048   &   2048   &   2048 \\ \hline
 \text{error} & 0.0032  &  0.0004  &  0.0008 \\ \hline
\end{array}
\]
...
Running Bratley et al. example ...

\[
\begin{array}{lcccccc}
   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
 \widehat{\underline{S}}_u & 0.6551  &  0.1792  &  0.0362  &  0.0007  &   0  &  0.0002 \\ \hline
 n & 4096 & 2048  &  1024  &  1024  &  1024  &  1024 \\ \hline
 \text{error} & 0.0023  &  0.0001  &  0.0008  &  0.0126  &  0.0015 &  0.0013 \\ \hline
 \widehat{\overline{S}}_u & 0.7397  &  0.2655  &  0.0786 &  0.0355  &  0.0078  &  0.0061 \\  \hline
 n & 4096  &  2048  &   1024  &   1024  &   1024  &  1024 \\ \hline
 \text{error} & 0.0001  &  0.0004  &  0.0022  &  0.0012  &  0.0016   & 0.0002 \\ \hline
\end{array}
\]
...
Running Sobol g-function example ...

\[
\begin{array}{lcccccc}
   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
 \widehat{\underline{S}}_u & 0.5868 & 0.2609  &  0.0373 & 0.0006  &  0  &  0 \\ \hline
 n & 4096  &  4096  &  1024  &  1024  &   1024  &  1024 \\ \hline
 \text{error} & 0.0000  &  0.0002  &  0.0006  &  0.0053 &   0.0001  &  0.0001 \\ \hline
 \widehat{\overline{S}}_u & 0.6910  &  0.3554  &  0.0563  &  0.0092  &  0.0001  &  0.0001 \\  \hline
 n & 4096  &   2048  &   1024  &   1024  &   1024  &  1024 \\ \hline
 \text{error} & 0.0009  &  0.0008  &  0.0001  &  0.0000  &  0.0000  &  0.0000 \\ \hline
\end{array}
\]
...
Running Morokoff and Caflish example ...

\[
\begin{array}{lcccccc}
   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
 \widehat{\underline{S}}_u & 0.1609 & 0.1570 & 0.1594 & 0.1577 & 0.1576 & 0.1572 \\ \hline
 n & 4096  & 4096  &  4096  & 4096  &  4096  &  4096 \\ \hline
 \text{error} & 0.0027  &  0.0012 &  0.0012 & 0.0005 & 0.0006 &  0.0010 \\ \hline
 \widehat{\overline{S}}_u & 0.1726 & 0.1753 & 0.1748 & 0.1767  &  0.1740  & 0.1767 \\  \hline
 n & 2048 & 2048  &  2048 & 2048  &   2048  &  2048 \\ \hline
 \text{error} & 0.0028  &  0.0000 &  0.0006  &  0.0013 & 0.0014  &  0.0013 \\ \hline
\end{array}
\]
