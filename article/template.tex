...
The two classical test functions considered are the g-function introduced by Sobol' \cite{Sobol'} and the function introduced by Bratley \textit{et al.} \cite{Bratley}. The idea is to test our method over two categories of functions: additive (g-function) and multiplicative (Bratley \textit{et al.} function).

\subsubsection{Sobol' g-function}

The g-function is defined as follows:
\begin{equation*}
f(\vx)= \prod \limits_{i=1}^{d}g_i(x_i), \qquad g_i(x_i)=\frac{\left |4x_i-2 \right | + a_i}{1 + a_i}, \ a_i \geq 0.
\end{equation*}
Each value $a_i$ determines the relative importance of the $x_i$. When the value of $a_i$ gets closer to zero the variable $x_i$ becomes more influential. Here, the dimension is $d=6$ and values chosen for the $a_i$ are given by the following vector $(a_1=0,=a_2=0.5, a_3=3, a_4=9, a_5=99$, $a_6=99)$.

Table \ref{res.gfunc.Aa} shows the averaged error bounds obtained with Variant $A.a$ as well as the averaged total number of evaluations performed. Table \ref{res.gfunc.Ab} shows the same results obtained with Variant $A.b$.
\renewcommand{\arraystretch}{1.3}
\begin{table}[!ht]
\caption{Averaged error bounds $\varepsilon_{\underline{S}_u}$ and $\varepsilon_{\overline{S}_u}$ obtained with Variant $A.a$ over $100$ repeats. Failure rates are denoted by ${err}_{\varepsilon_{\underline{S}_u}}$ and  ${err}_{\varepsilon_{\overline{S}_u}}$.}
\centering
...
\hline
 ...
 $x_5$ & $5.10^{-5}$ & $0.0003$ & $0$ & $9.10^{-5}$ & $0.0000$ & $0$ \\ \hline
 $x_6$ & $5.10^{-5}$ & $0.0003$ & $0$  & $9.10^{-5}$ & $0.0000$ & $0$ \\ \hline \hline
\multicolumn{4}{l}{Total number of evaluations: $63 \ 088$} & & &\\ \hline 
\end{tabular}
\label{res.gfunc.Aa}
\end{table}
\begin{table}[!ht]
\caption{Averaged error bounds $\varepsilon_{\underline{S}_u}$ and $\varepsilon_{\overline{S}_u}$ obtained with Variant $A.b$ over $100$ repeats. Failure rates are denoted by ${err}_{\varepsilon_{\underline{S}_u}}$ and  ${err}_{\varepsilon_{\overline{S}_u}}$.}
\centering
\begin{tabular}{ccccccc}
\hline
 input & $\underline{S}_u$ & $\varepsilon_{\underline{S}_u}$ & ${err}_{\varepsilon_{\underline{S}_u}}$ & $\overline{S}_u$ & $\varepsilon_{\overline{S}_u}$ &$err_{\varepsilon_{\overline{S}_u}}$ \\ \hline
 ...
 $x_5$ & $5.10^{-5}$ & $0.0000$ & $0$ & $9.10^{-5}$ & $0.0000$ & $0$ \\ \hline
 $x_6$ & $5.10^{-5}$ & $0.0000$ & $0$  & $9.10^{-5}$ & $0.0000$ & $0$ \\ \hline \hline
\multicolumn{4}{l}{Total number of evaluations: $62 \ 703$} & & &\\ \hline 
\end{tabular}
\label{res.gfunc.Ab}
\end{table}

The main observation is that both approaches give similar results both in terms of error bounds and total number of evaluations. Looking at those averaged results, the use of ``Correlation 2'' to estimate the four small first-order Sobol' indices $\underline{S}_3, \underline{S}_4, \underline{S}_5, \underline{S}_6$ does not seems to bring any improvements. We propose to draw boxplots to further investigate the results. 

Figure \ref{boxplots.gfunc} shows boxplots of the $100$ error bounds $\varepsilon_{\underline{S}_u}$ for the four inputs $x_3,x_4,x_5,x_6$ obtained with both Variant $A.a$ and $A.b$.
\begin{figure}[!ht]
\caption{Boxplots of error bounds $\varepsilon_{\underline{S}_u}$ for the four inputs $x_3,x_4,x_5,x_6$ obtained with both Variant $A.a$ and $A.b$.}
\centering
\includegraphics[width=0.45\textwidth]{Images/boxplots.pdf}
\label{boxplots.gfunc}
\end{figure}
As expected, the use of ``Correlation 2'' in Variant $A.b$ allows to obtain better error bounds. The discrepancy observed does not show off in Table \ref{res.gfunc.Ab} due to its low magnitude varying between $10^{-4}$ and $10^{-5}$.
\bigskip

Table \ref{res.gfunc.B} shows the averaged error bounds $\varepsilon_{\underline{S}_u}$ obtained with Variant $B$ and the averaged total number of evaluations performed. 
\begin{table}[!ht]
\caption{Averaged error bounds $\varepsilon_{\underline{S}_u}$  obtained with Variant $B$ over $100$ repeats. Failure rate is denoted by ${err}_{\varepsilon_{\underline{S}_u}}$.}
\centering
\begin{tabular}{cccc}
\hline
...
\label{res.gfunc.B}
\end{table}
Looking at the results, using Variant $B$ leads to higher failure rates than those obtained with Variant $A.a$ or $A.b$. The compromise is a total number of evaluations twice as small as the others two variants. As such, this approach remains interesting when one want to estimate only first-order indices.
...
% \widehat{\underline{S}}_u & 0.6500 & 0.1800 & 0.0370 & 0.0120 & 0.0034 & 0.0033 \\ \hline
% n & 17531 & 8438 & 4137 & 3686 & 625 & 650\\ \hline
% \text{error } & 0.0004 & 0.0006 & 0.0058 & 0.0022 & 0.0024 & 0.0021 \\ \hline
% \widehat{\overline{S}}_u & 0.7400 & 0.2700 & 0.0760 & 0.0340 & 0.0065 & 0.0064 \\  \hline
% n & 16384 & 8192 & 3113 & 1060 & 512 & 512 \\ \hline
% \text{error } & 0.0003 & 0.0004 & 0.0012 & 0.0020 & 0.0014 & 0.0010 \\ \hline
%\end{array}
%\]
...
%\begin{array}{lcccccc}
%   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
% \widehat{\underline{S}}_u & 0.5900 & 0.2600 & 0.0370 & 0.0060 & 0.0003 & 0.0003 \\ \hline
% n & 16138 & 9011 & 3748 & 891 & 512 & 512 \\ \hline
% \text{error } & 0.0004 & 0.0006 & 0.0011 & 0.0012 & 0.0003 & 0.0003 \\ \hline
% \widehat{\overline{S}}_u & 0.6900 & 0.3600 & 0.0560 & 0.0093 & 0.0001 & 0.0001 \\  \hline
% n & 11796 & 7496 & 1475 & 512 & 512 & 512 \\ \hline
% \text{error } & 0.0005 & 0.0004 & 0.0008 & 0.0003 & 0.0000 & 0.0000 \\ \hline
%\end{array}
%\]
%Reliability on the results,
%\[
...
%\]
%
%\subsubsection{With small indices estimator (threshold $0.1$)}
%Bratley et al. example:
%
%\[
%\begin{array}{lcccccc}
%   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
% \widehat{\underline{S}}_u & 0.6500 & 0.1800 & 0.0380 & 0.0140 & 0.0014 & 0.0016 \\ \hline
% n & 17203 & 8520 & 1362 & 517 & 512 & 512 \\ \hline
% \text{error } & 0.0004 & 0.0006 & 0.0019 & 0.0016 & 0.0003 & 0.0004 \\ \hline
% \widehat{\overline{S}}_u & 0.7400 & 0.2700 & 0.0760 & 0.0340 & 0.0063 & 0.0065 \\  \hline
% n & 16384 & 8192 & 2847 & 1142 & 512 & 512 \\ \hline
% \text{error } & 0.0003 & 0.0005 & 0.0013 & 0.0017 & 0.0015 & 0.0011 \\ \hline
%\end{array}
%\]
%Reliability on the results,
%\[
...
%\begin{array}{lcccccc}
%   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
% \widehat{\underline{S}}_u & 0.5900 & 0.2600 & 0.0370 & 0.0060 & 0.0001 & 0.0001 \\ \hline
% n & 16056 & 8929 & 1070 & 512 & 512 & 512 \\ \hline
% \text{error } & 0.0005 & 0.0007 & 0.0015 & 0.0003 & 0.0000 & 0.0000 \\ \hline
% \widehat{\overline{S}}_u & 0.6900 & 0.3600 & 0.0560 & 0.0093 & 0.0001 & 0.0001 \\  \hline
% n & 11551 & 7741 & 1464 & 512 & 512 & 512 \\ \hline
% \text{error } & 0.0006 & 0.0003 & 0.0009 & 0.0003 & 0.0000 & 0.0000 \\ \hline
%\end{array}
%\]
%Reliability on the results,
%\[
%\begin{array}{ cccccc }
%     97  & 97  & 95  & 100  &  100  & 100 \\
%     98  &  100  &  100 &  100  & 100 &  100
%\end{array}
%\]
%
...
%\begin{array}{lcccccc}
%   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
% \widehat{\underline{S}}_u & 0.6500 & 0.1800 & 0.0370 & 0.0100 & 0.0038 & 0.0040 \\ \hline
% n & 32768 & 16384 & 16384 & 12447 & 8637 & 9196 \\ \hline
% \text{error } & 0.0003 & 0.0006 & 0.0010 & 0.0038 & 0.0024 & 0.0026 \\ \hline
%\end{array}
%\]
%Reliability on the results,
%\[
...
%\begin{array}{lcccccc}
%   & u=\{1\} & u=\{2\} & u=\{3\} & u=\{4\} & u=\{5\} & u=\{6\} \\ \hline \hline
% \widehat{\underline{S}}_u & 0.5900 & 0.2600 & 0.0360 & 0.0059 & 0.0031 & 0.0036 \\ \hline
% n & 16384 & 16384 & 16225 & 14612 & 7086 & 6661 \\ \hline
% \text{error } & 0.0011 & 0.0013 & 0.0018 & 0.0013 & 0.0031 & 0.0036 \\ \hline
%\end{array}
%\]
%Reliability on the results,
%\[
