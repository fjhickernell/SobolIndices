...
tex file containing analytical expressions of four functions test and the associated true values of first-order
and total effect Sobol' indices
...
I will add soon comments to the code to ease the use of the function.
